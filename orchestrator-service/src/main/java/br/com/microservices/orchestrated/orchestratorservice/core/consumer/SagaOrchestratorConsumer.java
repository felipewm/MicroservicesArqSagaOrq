...
import br.com.microservices.orchestrated.orchestratorservice.core.util.JsonUtil;
...
public class SagaOrchestratorConsumer {
    ...
    public void finishSuccessEvent(String payload){
    ...
    public void finishFailEvent(String payload){
